...
const FEATURES = [
  { icon: Waves, label: 'Private Bay Access', desc: '50m to Mikros Gialos beach' },
            ...
            <FadeUp>
              <div>
                ...
                <div className="space-y-5 text-muted-foreground font-sans font-light leading-relaxed">
                  ...
                  <p>
                    {language === 'el'
                      ? 'Από 50 μέτρα μακριά, η ιδιωτική παραλία σας προσκαλεί για πρωινό μπάνιο. Τα βράδια, τα αστέρια είναι το μόνο φως που χρειάζεστε.'
                      : 'Fifty metres away, a private beach invites you for a morning swim. In the evenings, the stars are the only light you need.'}
                  </p>
                </div>
                <div className="mt-10">
                  <Link
