...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'privacy.section2.item4': 'Contact form inquiries and booking requests submitted through our website',
    ...
    'privacy.section6.content': 'We use Formspree (formspree.io) to process contact form and booking request submissions. When you submit a form, your data is transmitted to Formspree servers for processing. Formspree may store this data on servers located in the United States. For more information, please review Formspree\'s privacy policy at https://formspree.io/legal/privacy-policy.',
    'privacy.section7.title': '7. Contact Us',
    'privacy.section7.content': 'If you have questions or comments about this policy, you may email us at metaxasretreats@gmail.com.',
    ...
    'terms.section2.title': '2. Check-in & Check-out',
    ...
    'terms.section3.rule3': 'Quiet hours are from 15:00 to 17:30 in the afternoon and from 23:00 to 07:00.',
  ...
  el: {
    ...
    'privacy.section2.item4': 'Ερωτήματα φόρμας επικοινωνίας και αιτήματα κράτησης που υποβάλλονται μέσω του ιστότοπού μας',
    ...
    'privacy.section6.title': '6. Υπηρεσίες Τρίτων',
    'privacy.section6.content': 'Χρησιμοποιούμε το Formspree (formspree.io) για την επεξεργασία υποβολών φόρμας επικοινωνίας και αιτημάτων κράτησης. Όταν υποβάλλετε μια φόρμα, τα δεδομένα σας μεταδίδονται στους διακομιστές του Formspree για επεξεργασία. Το Formspree μπορεί να αποθηκεύσει αυτά τα δεδομένα σε διακομιστές που βρίσκονται στις Ηνωμένες Πολιτείες. Για περισσότερες πληροφορίες, ανατρέξτε στην πολιτική απορρήτου του Formspree στο https://formspree.io/legal/privacy-policy.',
    'privacy.section7.title': '7. Επικοινωνήστε Μαζί Μας',
    'privacy.section7.content': 'Εάν έχετε ερωτήσεις ή σχόλια σχετικά με αυτήν την πολιτική, μπορείτε να μας στείλετε email στο metaxasretreats@gmail.com.',
    ...
    'terms.section3.rule3': 'Ώρες κοινής ησυχίας από 15:00 έως 17:30 το απόγευμα και από 23:00 έως 07:00.',
  ...
  it: {
    ...
    'privacy.section2.item4': 'Richieste di contatto e prenotazione inviate attraverso il nostro sito web',
    ...
    'privacy.section6.title': '6. Servizi di Terze Parti',
    'privacy.section6.content': 'Utilizziamo Formspree (formspree.io) per elaborare le richieste di contatto e prenotazione. Quando invii un modulo, i tuoi dati vengono trasmessi ai server di Formspree per l\'elaborazione. Formspree può memorizzare questi dati su server situati negli Stati Uniti. Per maggiori informazioni, consulta l\'informativa sulla privacy di Formspree su https://formspree.io/legal/privacy-policy.',
    'privacy.section7.title': '7. Contattaci',
    'privacy.section7.content': 'Se hai domande o commenti su questa informativa, puoi scriverci a metaxasretreats@gmail.com.',
    ...
    'terms.section3.rule3': 'Ore di silenzio dalle 15:00 alle 17:30 nel pomeriggio e dalle 23:00 alle 07:00.',
  ...
  de: {
    ...
    'privacy.section2.item4': 'Kontaktanfragen und Buchungsanfragen, die über unsere Website eingereicht werden',
    ...
    'privacy.section6.title': '6. Drittanbieter-Dienste',
    'privacy.section6.content': 'Wir verwenden Formspree (formspree.io) zur Verarbeitung von Kontaktformular- und Buchungsanfragen. Wenn Sie ein Formular absenden, werden Ihre Daten zur Verarbeitung an Formspree-Server übertragen. Formspree kann diese Daten auf Servern in den Vereinigten Staaten speichern. Weitere Informationen finden Sie in der Datenschutzerklärung von Formspree unter https://formspree.io/legal/privacy-policy.',
    'privacy.section7.title': '7. Kontaktieren Sie Uns',
    'privacy.section7.content': 'Wenn Sie Fragen oder Kommentare zu dieser Erklärung haben, können Sie uns per E-Mail an metaxasretreats@gmail.com kontaktieren.',
    ...
    'terms.section3.rule3': 'Ruhezeiten sind von 15:00 bis 17:30 Uhr nachmittags und von 23:00 bis 07:00 Uhr.',
  ...
  ro: {
    ...
    'privacy.section2.item4': 'Solicitări de contact și cereri de rezervare trimise prin site-ul nostru',
    ...
    'privacy.section6.title': '6. Servicii Terțe',
    'privacy.section6.content': 'Utilizăm Formspree (formspree.io) pentru a procesa cererile de contact și rezervare. Când trimiteți un formular, datele dumneavoastră sunt transmise către serverele Formspree pentru procesare. Formspree poate stoca aceste date pe servere situate în Statele Unite. Pentru mai multe informații, vă rugăm să consultați politica de confidențialitate Formspree la https://formspree.io/legal/privacy-policy.',
    'privacy.section7.title': '7. Contactează-ne',
    'privacy.section7.content': 'Dacă aveți întrebări sau comentarii despre această politică, ne puteți scrie la metaxasretreats@gmail.com.',
    ...
    'terms.section3.rule3': 'Orele de liniște sunt de la 15:00 la 17:30 după-amiaza și de la 23:00 la 07:00.',
